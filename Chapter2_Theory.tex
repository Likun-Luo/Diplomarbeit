...
\begin{figure}[H]
	...
	\caption{X-Wagen metro train at Siemens Mobility Austria company location Leberstraße \cite{foto_ubx}.}
	\label{fig:ubx_foto}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Sketchup model of the UBX.}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Sketchup model of the non-driven bogie.}
\end{figure}
